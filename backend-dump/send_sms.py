...
def send_greeting_sms(receiver_number, user_name, camp_name, camp_complete_address, camp_start_time, camp_end_time):
    ...
    greeting_message = f"Hi {user_name}. Sehat Sampark is hosting '{camp_name}' at your nearest location {camp_complete_address}. Visit the location between {camp_start_time} to {camp_end_time}. Link if needed: https://www.google.com/maps?q={camp_complete_address}"
    url = "https://api.pushbullet.com/v2/texts"
...
#     response_message = send_greeting_sms(user_phone_number, user_name, camp_name="Free health Camp", camp_complete_address="Gurgaon", camp_start_time="10:00", camp_end_time="12:00")
