...
for i in users:
    ...
    response_message = send_greeting_sms(user_phone_number, user_name, camp_name="Free health Camp", camp_complete_address="Gurgaon", camp_start_time="10:00 AM", camp_end_time="12:00 PM")
